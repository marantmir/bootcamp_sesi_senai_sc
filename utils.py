...
FALHAS = ['FDF','FDC','FP','FTE','FA']  # ordem exigida pela API
...
def preparar_dados(df, treino=True, adicionar_dif_temp=True, adicionar_potencia=True,
    ...
    if treino:
        ...
        if col_falhas:
            ...
            # primeiro modo de falha positivo encontrado; caso nenhum, 'NF'
            ...
            # robusto a valores não numéricos
...
def submission_csv(df_multilabel):
    """
    Garante o CSV exatamente no formato exigido pela API:
    colunas = ['FDF','FDC','FP','FTE','FA'] (nessa ordem), sem coluna 'id'.
    """
